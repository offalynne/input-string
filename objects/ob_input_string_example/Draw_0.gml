...
draw_text(room_width - 10,  50, "\"" + string_replace_all(keyboard_string, "\n", " ")  + "\"  keyboard_string          ");
...
if (search_test_index >= 0) 
{
    ...
    _search = string_copy(_search, 2, string_length(_search) - 3);    
    draw_text(room_width / 2, room_height - 30, _search);
}
